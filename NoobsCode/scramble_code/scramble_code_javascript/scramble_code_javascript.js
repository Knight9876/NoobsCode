...
function javascript() {
    let javascript_display_code_1 = `var b = 2
var a = 1
console.log(a + b)`;

    let javascript_display_code_2 = `var a = 1
console.log(a - b)
var b = 2`;

    let javascript_display_code_3 = `console.log(a * b)
var a = 1
var b = 2`;

    let javascript_display_code_4 = `console.log(a / b)
var b = 2
var a = 1`;

    let javascript_display_code_5 = `var a = 1
console.log(a % b)
var b = 2`;
    ...
    textarea.value = random_javascript_display_code;
