...
function python() {
    // open("../blind_code/blind_code.html", "_self")
    let python_display_code_1 = `a = 1<br>
                            b = 2<br>
                            print(a + b)`;

    let python_display_code_2 = `a = 1<br>
                            b = 2<br>
                            print(a - b)`;

    let python_display_code_3 = `a = 1<br>
                            b = 2<br>
                            print(a * b)`;

    let python_display_code_4 = `a = 1<br>
                            b = 2<br>
                            print(a // b)`;

    let python_display_code_5 = `a = 1<br>
                            b = 2<br>
                            print(a % b)`;
    ...
    code.innerHTML = random_python_display_code;
